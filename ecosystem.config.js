  ...
  apps: [
    {
      ...
      script: "/Users/opieclaw/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/opieclaw/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/opieclaw/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/opieclaw/cortextos",
        CTX_PROJECT_ROOT: "/Users/opieclaw/cortextos",
        CTX_ORG: process.env.CTX_ORG || "life-os",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: "npm",
      args: "run dev",
      cwd: "/Users/opieclaw/cortextos/dashboard",
      env: {
